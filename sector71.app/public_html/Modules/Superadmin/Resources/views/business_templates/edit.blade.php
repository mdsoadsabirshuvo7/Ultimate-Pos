@extends('layouts.app')
@section('title', __('superadmin::lang.superadmin') . ' | ' . __('superadmin::lang.edit_business_template'))

@section('content')
@include('superadmin::layouts.nav')
<section class="content-header">
    <h1>@lang('superadmin::lang.edit_business_template'): {{$template->name}}</h1>
</section>

<section class="content">
    {!! Form::open(['action' => ['\Modules\Superadmin\Http\Controllers\BusinessTemplateController@update', $template->id], 'method' => 'put', 'id' => 'template_form']) !!}
        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::select('icon', $icons, $template->icon, ['class' => 'form-control select2']) !!}
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('color', __('superadmin::lang.color') . ':') !!}
                        {!! Form::select('color', $colors, $template->color, ['class' => 'form-control select2']) !!}
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        {!! Form::textarea('description', $template->description, ['class' => 'form-control', 'rows' => 2]) !!}
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        {!! Form::label('sort_order', __('superadmin::lang.sort_order') . ':') !!}
                        {!! Form::number('sort_order', $template->sort_order, ['class' => 'form-control', 'min' => 0]) !!}
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('is_active', 1, $template->is_active, ['class' => 'input-icheck']) !!}
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div id="template_preview" style="display: inline-block; padding: 15px 25px; border-radius: 5px; background-color: {{$template->color}}; color: white; text-align: center;">
                        <i id="preview_icon" class="{{$template->icon}}"></i>
    ...
    <div class="box box-solid">
        <div class="box-header with-border">
            ...
            <div class="box-tools">
                <button type="button" class="btn btn-primary btn-sm" id="add_category"><i class="fa fa-plus"></i> @lang('category.add_category')</button>
            </div>
        </div>
        <div class="box-body">
            <div id="categories_container"><p class="text-muted">No categories added</p></div>
    ...
    <div class="box box-solid">
        <div class="box-header with-border">
            ...
            <div class="box-tools">
                <button type="button" class="btn btn-primary btn-sm" id="add_unit"><i class="fa fa-plus"></i> @lang('unit.add_unit')</button>
            </div>
        </div>
        <div class="box-body">
            <div id="units_container"><p class="text-muted">No units added</p></div>
    ...
    <div class="box box-solid">
        <div class="box-header with-border">
            ...
            <div class="box-tools">
                <button type="button" class="btn btn-primary btn-sm" id="add_tax"><i class="fa fa-plus"></i> @lang('tax_rate.add_tax_rate')</button>
            </div>
        </div>
        <div class="box-body">
            <div id="tax_rates_container"><p class="text-muted">No tax rates added</p></div>
    ...
    <div class="box box-solid">
        <div class="box-header with-border">
            ...
            <div class="box-tools">
                <button type="button" class="btn btn-primary btn-sm" id="add_product"><i class="fa fa-plus"></i> @lang('product.add_product')</button>
            </div>
        </div>
        <div class="box-body">
            <div id="products_container"><p class="text-muted">No products added</p></div>
    ...
    <div class="box box-solid">
        <div class="box-header with-border">
            ...
            <div class="box-tools">
                <button type="button" class="btn btn-primary btn-sm" id="add_brand"><i class="fa fa-plus"></i> @lang('brand.add_brand')</button>
            </div>
        </div>
        <div class="box-body">
            <div id="brands_container"><p class="text-muted">No brands added</p></div>
    ...
    <div class="box box-solid">
        <div class="box-body">
            <button type="submit" class="btn btn-primary pull-right"><i class="fa fa-save"></i> @lang('messages.update')</button>
        </div>
    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group"><label>Name:*</label><input type="text" class="form-control" id="category_name"></div>
                <div class="form-group"><label>Description:</label><textarea class="form-control" id="category_description" rows="2"></textarea></div>
            </div>
...
<div class="modal fade" id="unit_modal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group"><label>Name:*</label><input type="text" class="form-control" id="unit_name"></div>
                <div class="form-group"><label>Short Name:*</label><input type="text" class="form-control" id="unit_short_name"></div>
                <div class="form-group"><label><input type="checkbox" id="unit_allow_decimal"> Allow Decimal</label></div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
...
<div class="modal fade" id="tax_modal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group"><label>Name:*</label><input type="text" class="form-control" id="tax_name"></div>
                <div class="form-group"><label>Rate (%):*</label><input type="number" step="0.01" class="form-control" id="tax_rate"></div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
...
<div class="modal fade" id="product_modal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group"><label>Name:*</label><input type="text" class="form-control" id="product_name"></div>
                <div class="form-group"><label>SKU:</label><input type="text" class="form-control" id="product_sku"></div>
                <div class="row">
                    <div class="col-md-6"><div class="form-group"><label>Purchase Price:</label><input type="number" step="0.01" class="form-control" id="product_purchase_price" value="0"></div></div>
                    <div class="col-md-6"><div class="form-group"><label>Selling Price:</label><input type="number" step="0.01" class="form-control" id="product_selling_price" value="0"></div></div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
...
<div class="modal fade" id="brand_modal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group"><label>Name:*</label><input type="text" class="form-control" id="brand_name"></div>
                <div class="form-group"><label>Description:</label><textarea class="form-control" id="brand_description" rows="2"></textarea></div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
...
$(document).ready(function() {
    var categories = @json($template->categories ?? []);
    var units = @json($template->units ?? []);
    var tax_rates = @json($template->tax_rates ?? []);
    var products = @json($template->products ?? []);
    var brands = @json($template->brands ?? []);
    ...
    $('#add_category').click(function() { $('#category_name').val(''); $('#category_description').val(''); $('#category_modal').modal('show'); });
    ...
    $(document).on('click', '.remove-category', function() { categories.splice($(this).data('index'), 1); renderCategories(); });
    ...
    $('#add_unit').click(function() { $('#unit_name').val(''); $('#unit_short_name').val(''); $('#unit_allow_decimal').prop('checked', false); $('#unit_modal').modal('show'); });
    ...
    $(document).on('click', '.remove-unit', function() { units.splice($(this).data('index'), 1); renderUnits(); });
    ...
    $('#add_tax').click(function() { $('#tax_name').val(''); $('#tax_rate').val(''); $('#tax_modal').modal('show'); });
    $('#save_tax').click(function() {
        ...
        if (!tax_rates) tax_rates = [];
        tax_rates.push({ name: name, rate: parseFloat(rate) });
        renderTaxRates();
        $('#tax_modal').modal('hide');
    });
    $(document).on('click', '.remove-tax', function() { tax_rates.splice($(this).data('index'), 1); renderTaxRates(); });
    ...
    function renderProducts() {
        ...
        if (!products || products.length === 0) {
            ...
            var html = '<table class="table table-condensed table-bordered"><thead><tr><th>Name</th><th>SKU</th><th>Purchase</th><th>Selling</th><th>Action</th></tr></thead><tbody>';
    ...
    $('#add_product').click(function() { $('#product_name').val(''); $('#product_sku').val(''); $('#product_purchase_price').val('0'); $('#product_selling_price').val('0'); $('#product_modal').modal('show'); });
    $('#save_product').click(function() {
        var name = $('#product_name').val().trim();
        if (!name) { toastr.error('Name is required'); return; }
        if (!products) products = [];
        products.push({ name: name, sku: $('#product_sku').val().trim(), purchase_price: parseFloat($('#product_purchase_price').val()) || 0, selling_price: parseFloat($('#product_selling_price').val()) || 0 });
        renderProducts();
        $('#product_modal').modal('hide');
    });
    $(document).on('click', '.remove-product', function() { products.splice($(this).data('index'), 1); renderProducts(); });
    ...
    $('#add_brand').click(function() { $('#brand_name').val(''); $('#brand_description').val(''); $('#brand_modal').modal('show'); });
    ...
    $(document).on('click', '.remove-brand', function() { brands.splice($(this).data('index'), 1); renderBrands(); });
