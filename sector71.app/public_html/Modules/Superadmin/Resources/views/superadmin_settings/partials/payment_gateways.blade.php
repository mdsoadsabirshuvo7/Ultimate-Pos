<div class="pos-tab-content">
    ...
    <div class="row">
        ...
        <h4>Sector71 Pay: <small>(Local gateway integration)</small></h4>
        <div class="col-xs-6">
            <div class="form-group">
                {!! Form::label('SECTOR71PAY_API_KEY', 'API Key:') !!}
                {!! Form::text('SECTOR71PAY_API_KEY', $default_values['SECTOR71PAY_API_KEY'], ['class' => 'form-control']); !!}
            </div>
        </div>
        <div class="col-xs-6">
            <div class="form-group">
                {!! Form::label('SECTOR71PAY_SECRET_KEY', 'Secret Key:') !!}
                {!! Form::text('SECTOR71PAY_SECRET_KEY', $default_values['SECTOR71PAY_SECRET_KEY'], ['class' => 'form-control']); !!}
            </div>
        </div>
        <div class="col-xs-6">
            <div class="form-group">
                {!! Form::label('SECTOR71PAY_BRAND_KEY', 'Brand Key:') !!}
                {!! Form::text('SECTOR71PAY_BRAND_KEY', $default_values['SECTOR71PAY_BRAND_KEY'], ['class' => 'form-control']); !!}
            </div>
        </div>
        <div class="col-xs-6">
            <div class="form-group">
                {!! Form::label('SECTOR71PAY_CREATE_URL', 'Create API URL:') !!}
                {!! Form::text('SECTOR71PAY_CREATE_URL', $default_values['SECTOR71PAY_CREATE_URL'], ['class' => 'form-control', 'placeholder' => 'https://pay.sector71.codes/api/payment/create']); !!}
            </div>
        </div>
        <div class="col-xs-12">
            <div class="form-group">
                {!! Form::label('SECTOR71PAY_VERIFY_URL', 'Verify API URL:') !!}
                {!! Form::text('SECTOR71PAY_VERIFY_URL', $default_values['SECTOR71PAY_VERIFY_URL'], ['class' => 'form-control', 'placeholder' => 'https://pay.sector71.codes/api/payment/verify']); !!}
            </div>
        </div>
