...
@if(session('status') && isset(session('status')['success']) && session('status')['success'] == 1 && isset(session('status')['msg']) && session('status')['msg'] == __('lang_v1.success'))
    <!-- Track Facebook Purchase Event after successful subscription payment -->
    <script>
