        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li @if(request()->segment(1) == 'superadmin' && request()->segment(2) == 'business-templates') class="active" @endif><a href="{{action([\Modules\Superadmin\Http\Controllers\BusinessTemplateController::class, 'index'])}}">@lang('superadmin::lang.business_templates')</a></li>
