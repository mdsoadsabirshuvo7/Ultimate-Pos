...
class BaseController extends Controller
{
    ...
    public function _payment_gateways()
    {
        ...
        // Check if Sector71 Pay is configured or not
        if ((env('SECTOR71PAY_API_KEY', env('PAYMENTKORO_API_KEY'))) && (env('SECTOR71PAY_SECRET_KEY', env('PAYMENTKORO_SECRET_KEY'))) && (env('SECTOR71PAY_BRAND_KEY', env('PAYMENTKORO_BRAND_KEY')))) {
            $gateways['paymentkoro'] = 'Sector71 Pay';
        }
