    ...
    <nav class="hero-nav position-relative container mx-auto px-0">
        <ul class="nav w-100 list-unstyled align-items-center p-0">
            <li class="hero-nav__item">
                <a href="{{url('/')}}">
                    <img class="hero-nav__logo" src="{{ asset('modules/cms/img/sector71-logo.jpg') }}" 
                        change-src-onscroll="{{ asset('modules/cms/img/sector71-logo.jpg') }}" alt="Sector 71 logo" loading="lazy">
                </a>
