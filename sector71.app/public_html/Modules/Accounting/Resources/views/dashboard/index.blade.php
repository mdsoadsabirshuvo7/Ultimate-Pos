...
@section('css')
<style>
    .highcharts-container, [data-highcharts-chart] { max-height: 300px !important; }
    [id$="_loader"] { display: none !important; height: 0 !important; }
    #app:empty { height: 0 !important; overflow: hidden !important; margin: 0 !important; padding: 0 !important; min-height: 0 !important; }

    /* Keep accounting content aligned with fixed sidebar on desktop */
            ...
            <div class="col-md-12">
                @component('accounting::components.box')
                    ...
                    @slot('body')
                        ...
                        <div class="col-md-6">
                            <canvas id="balance_summary_chart" style="max-height:250px;"></canvas>
                        </div>
                    @endslot
                @endcomponent
            </div>
